...
This chapter introduces another new package that we haven't seen in previous chapters. We'll be using the **`lubridate`** package for manipulating dates. You'll see more examples of **`lubridate`** in @sec-r-pkgs.
