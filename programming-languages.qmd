...
The aspects of the data that we are interested in visualising are:
...
You'll notice that the subtitle text runs off the edge of the plot here - we'll deal with that a little bit later. Let's first decide on a font to use in the plot.
