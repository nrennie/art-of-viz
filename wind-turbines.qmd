...
#| eval: false
c(
  "dplyr", "ggplot2", "glue", "marquee",
  "openxlsx", "rcartocolor", "readr", "showtext",
  "stringr", "sysfonts", "waffle"
)
```
...
The Canadian Wind Turbine data contains information licensed under the [Open Government Licence - Canada](https://open.canada.ca/en/open-government-licence-canada). You can search for more open data at [search.open.canada.ca/opendata](https://search.open.canada.ca/opendata/). See @sec-doctors for further discussion of open data sources.
...
For example, the {GGally} package ...

```{r}
#| label: fig-turbines-ggally
#| fig-cap: "A 3x3 grid of comparisons between three columns in the `wind_turbines` data showing "
#| fig-alt: ""
#| fig-asp: 1
#| message: false
#| echo: -1
