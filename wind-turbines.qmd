...
![Initial sketch of a faceted area charts showing packages use over time](images/sketch-turbines.png){#fig-sketch-turbines fig-align="center" fig-alt="Initial sketch of a faceted area charts showing packages use over time. Notes indicate color by province and how one icon represents X turbines."}
