...
All of the packages that we're using in this chapter are ones that we've used previously in other chapters. However, we'll be going into a bit more depth on some of them and using new functions from some of them!
...
#| fig-alt: "Bubble plot of the relationship between the age of pet cats and the average amount of time they spend indoors. A title, subtitle, and caption has been added, although the caption appears with raw HTML code, rather than correctly formatted."
