...
For this chapter, we'll visualise data on [Medical doctors per 1,000 people](https://ourworldindata.org/grapher/physicians-per-1000-people),  a dataset which comes from the Our World in Data website [@doctors_data]. You can load the data using the {owidR} R package [@owidR]:
...
\index{readr!read\_csv} \index{owidR!owid}
