...
We also create a custom caption with Font Awesome icons, as described in @sec-chap4. Remember to update the `caption` variable to include the source of the data for this visualisation.
...
* We could instead use colored text in the subtitle to indicate what the categories are, as we did in @sec-chap4. For this visualisation, highlighting the *Immunized* would be enough as there are only two categories.
