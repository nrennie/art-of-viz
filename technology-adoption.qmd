...
We also create a custom caption with Font Awesome icons, as described in @sec-chap6. Remember to update the `caption` variable to include the source of the data for this visualisation.
