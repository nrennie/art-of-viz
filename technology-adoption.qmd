...
* We could instead use colored text in the subtitle to indicate what the categories are, as we did in @sec-chap5. For this visualisation, highlighting the *Immunized* would be enough as there are only two categories.
