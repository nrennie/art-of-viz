...
#| echo: -1
theme_set(theme_void(base_size = 2))
...
If you do have to use colors to differentiate groups, add direct labels to data where possible, and make sure that the order of the legend matches the order of the data [@GAcharts]. So let's remove the legend, by setting `legend.position = "none"` inside `theme()`: \index{ggplot2!theme}
