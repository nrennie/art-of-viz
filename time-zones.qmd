...
![Initial sketch of time zone locations as points on a world map.](images/sketch-time-zones.png){#fig-time-zones-sketch fig-align="center" fig-alt=""}
...
![Initial sketch of points on a world map with text in the lower left corner, and a bar chart as a legend in the bottom right.](images/sketch-time-zones-2.png){#fig-time-zones-sketch fig-align="center" fig-alt=""}
...
![](images/time-zones.gif){fig-align="center" fig-alt=""}
