...
Finally, we need to join the legend bar chart to our main plot. For this, we'll use {patchwork} [@patchwork]. The {patchwork} package allows you to .... 

**TODO tip about patchwork**
