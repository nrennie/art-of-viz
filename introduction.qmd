...
Each chapter is a case study of a different visualization, and follows the same structure:
...
* **Reflection**: some thoughts on how the visualization may be improved
* **Exercises**: a few questions for following up on improving the visualizations
