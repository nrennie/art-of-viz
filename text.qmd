...
Fonts and text are not often the first elements to be considered when developing charts, perhaps since plots are often labeled as a better alternative to textual descriptions of data. That being said, careful use of fonts can make plots clearer and more interesting.
...
* [Chapter]{.content-visible when-format="html"} @sec-cats describes an alternative approach to adding colored text with **`ggtext`**, and it illustrates how to create data-driven annotations that update when your data does. This chapter also shows you how to write a function that adds social media icons to your plot captions.
...
Part II also covers how to obtain data from an API using R, and writing functions to parameterize plots, enabling you to create different versions of the same chart for different subsets of data.