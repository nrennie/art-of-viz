...
* [Chapter]{.content-visible when-format="html"} @sec-nobel considers how to visualize text data, in a way that is both aesthetically pleasing but brings more clarity than the default choice of word clouds.
