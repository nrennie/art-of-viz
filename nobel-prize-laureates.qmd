...
We can some further, final customizations by changing the following `theme()` elements: \index{ggplot2!theme} \index{ggplot2!element\_rect} \index{ggtext!element\_textbox\_simple} \index{ggplot2!margin}
