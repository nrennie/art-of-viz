...
The USDA honey bee colony data was used as a TidyTuesday [@tidytuesday] data set in January 2022, and so can be loaded in using the {tidytuesdayR} package: \index{tidytuesdayR!tt\_load}
