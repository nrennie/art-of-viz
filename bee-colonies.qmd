...
#| eval: false
c(
  "dplyr", "ggplot2", "ggtext", "poissoned",
...
![Initial sketch showing a grid of squares, with each square representing a combination of year and US state.](images/sketch-bees-blank.png){#fig-bees-sketch-blank fig-align="center" fig-alt=""}
...
![Initial sketch showing a grid of squares, with the number of dots representing the number of bee colonies in each year and US state.](images/sketch-bees.png){#fig-bees-sketch fig-align="center" fig-alt=""}
