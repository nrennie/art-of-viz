...
The packages required for this chapter are:

* {dplyr}: for manipulating data
* {ggplot2}: for creating most elements of the visualisations
* {ggtext}: for adding HTML code to text elements
* {showtext}: for using fonts more easily
* {sysfonts}: for loading additional fonts
* {tidyr}: for creating tidy data
* {tidytuesdayR}: (optional) for reading in #TidyTuesday data
...
#| label: pkgs
#| eval: false
pkgs <- c("dplyr", "ggplot2", "ggtext", "showtext", "sysfonts", "tidyr", "tidytuesdayR")
install.packages(pkgs)
```

Original code: [github.com/nrennie/tidytuesday/blob/main/2023/2023-03-21/20230321.R](https://github.com/nrennie/tidytuesday/blob/main/2023/2023-03-21/20230321.R)

R4DS: [github.com/rfordatascience/tidytuesday/blob/master/data/2023/2023-03-21](https://github.com/rfordatascience/tidytuesday/blob/master/data/2023/2023-03-21)
