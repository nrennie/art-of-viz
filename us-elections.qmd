...
We're once again going to create a faceted plot, as we did in @sec-programming, @sec-museums, and @sec-longbeach. There are two key differences with this plot:
