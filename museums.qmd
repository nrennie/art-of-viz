...
#| eval: false
c(
  "dplyr", "gghighlight", "ggplot2", "ggtext",
  "purrr", "showtext", "sysfonts", "tibble",
  "tidyr", "tidytuesdayR", "viridis"
)
```
...
* **{tidyplots}** [@tidyplots]: a newer graphics package aiming to make it easier to create publication-ready plots for scientific papers. It allows you to pipe together different functions, and add statistical summaries more easily.
...
```{r}
#| label: museums-fonts
sysfonts::font_add_google(name = "Raleway")
