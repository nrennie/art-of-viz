...
detect_outline_2 <- imager::px.flood(
  im = lemur_img,
  x = 430,
  y = 220,
  sigma = 0.063
...
To make it easier to create a transparent background, we turn the areas outside of the selected pixel sets to black. We do this by setting the pixel values to `0` i.e. no color. 
