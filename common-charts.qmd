...
* [Chapter]{.content-visible when-format="html"} @sec-programming teaches you how to make a dumbbell chart with **`ggplot2`** and discusses styling charts thematically based on the data they contain.
...
* [Chapter]{.content-visible when-format="html"} @sec-longbeach discusses how to use the **`ggforce`** extension package to build your own customized charts, and convert a bar chart into a gauge chart. 

Part I also covers loading fonts into R and installing packages from GitHub. 
