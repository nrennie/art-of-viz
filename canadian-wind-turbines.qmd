...
We add this ... in the normal way, by passing them into the `labs()` function: \index{ggplot2!labs}
...
You'll notice that ... . (we'll deal with this is a second - we haven't actually used {marquee} yet )
