...
You can search for [search.open.canada.ca/opendata](https://search.open.canada.ca/opendata/)
...
wind_turbines <- openxlsx::read.xlsx(xlsxFile = url, sheet = 1)
```
